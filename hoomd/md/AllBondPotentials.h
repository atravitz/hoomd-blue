...
#include "EvaluatorBondDynamicCohenPade.h"
...
//! Bond potential force compute for Cohen-Pade forces
typedef PotentialBond<EvaluatorBondDynamicCohenPade> PotentialBondDynamicCohenPade;
